...
// BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::BWTree(KeyComparator, KeyEqualityChecker kc) {
// if (true)
// {
//   return;
// }
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool CASMappingTable<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Install(uint64_t id, Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_ptr){

	if(node_ptr->chain_len == 0){
		cas_mapping_table.insert(pair<uint64_t, Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(id, node_ptr));
		return true;
	}

	while(true){	
		Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* old_node = node_ptr->next;
		typename map<uint64_t, Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>::iterator iter = cas_mapping_table.find(id);
		Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* address = iter -> second;
		if(__sync_bool_compare_and_swap(&address, old_node, node_ptr)){
			break;
		}
		Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* cur_node = cas_mapping_table[id];
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* CASMappingTable<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Get (uint64_t id){
	return cas_mapping_table[id];
}


template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
uint64_t CASMappingTable<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Get_next_id (){
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Consolidate(uint64_t id, bool force) {
  if (id == 0)
  {
    if (force)
    {
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Split_root(KeyType split_key, uint64_t left_pointer, uint64_t right_pointer) {
	uint64_t new_root_id = this->table.Get_next_id();
	uint64_t old_root_id = root;
	InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* internal_pointer = new InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(*this, new_root_id);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
vector<ValueType> BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Search_key(KeyType key) {
  vector<ValueType> ret_vector;
	...
	Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> * node_pointer = table.Get(node_id);
  //Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *node_pointer = node_.first;
  multimap<KeyType, ValueType, KeyComparator> deleted_keys;
  while(node_pointer){
    switch(node_pointer->type){
      case(INSERT):
      {      
        DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* simple_pointer = nullptr;
        simple_pointer = dynamic_cast<DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
      ...
      case(SPLIT):
      {
        //SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *split_pointer = nullptr;
        //split_pointer = dynamic_cast<SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
      ...
      case(MERGE):
      {
        MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *merge_pointer = nullptr;
        merge_pointer = dynamic_cast<MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
      ...
      case(LEAF_BW_NODE):
      {
        LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *leaf_pointer = nullptr;
        leaf_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Insert(
  ...
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *cur_pointer = node_pointer;
  while(cur_pointer->next)
    cur_pointer = cur_pointer->next;
LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* leaf_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(cur_pointer); 
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Delete(KeyType key, ValueType value) {
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
uint64_t 
BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Search(KeyType key, uint64_t *path, uint64_t &location) {
  ...
  uint64_t index = 0;
  location = 0;
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_pointer = nullptr;
  while(!stop){
    ...
    switch(node_pointer->type){
      case(LEAF_BW_NODE):
{        LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* leaf_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
        return leaf_pointer->id;}
        break;
      case(INTERNAL_BW_NODE):
{        InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* internal_pointer = dynamic_cast<InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
        prev_id = cur_id;
...
{       
  ...
  simple_pointer = dynamic_cast<DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
      //TODO: figure out what is equals
        ...
        break;
      case(SPLIT):
{        SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *split_pointer = dynamic_cast<SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
        ...
        break;
      case(MERGE):
{        MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *merge_pointer = dynamic_cast<MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
        if(comparator(key, merge_pointer->merge_key)){
      ...
      case(REMOVE):
        ...
        break;
      case(SPLIT_INDEX):
{        SplitIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *split_index_pointer = dynamic_cast<SplitIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer); 
        ...
        break;
      case(REMOVE_INDEX):
{        RemoveIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *delete_index_pointer = dynamic_cast<RemoveIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Leaf_insert(KeyType key, ValueType value){
  DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* delta = 
  new DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id, INSERT);
  delta->key = key;
  delta->value = value;
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_ = (this->my_tree).table.Get(this->id);
  delta->next = node_;
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Leaf_delete(KeyType key, ValueType value){
  DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* delta = 
  new DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id, DELETE);
  delta->key = key;
  delta->value = value;
  delta-> type = DELETE;
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_ = this->my_tree.table.Get(this->id);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Leaf_split(uint64_t *path, uint64_t index, KeyType key, ValueType value){
  ...
  LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* new_leaf_node = new LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, new_node_id);
  ...
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_ = (this->my_tree).table.Get(this -> id);
  SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* split_node = new SplitDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id);
  ...
  if(index > 0){
	  ...
	  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* parent_node_ = this->my_tree.table.Get(parent_id);
	  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *cur_pointer = parent_node_;
	  while(cur_pointer->next)
		cur_pointer = cur_pointer->next;

	  InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* internal_pointer = dynamic_cast<InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(cur_pointer);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Internal_merge(uint64_t *path, uint64_t index, KeyType merge_key){
	...
	if(this->sibling_id != 0){
		...
		Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *n_node_ = this->my_tree.table.Get(neighbour_node_id);
		InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* n_node_pointer = dynamic_cast<InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(n_node_);
		...
		if(total_count > this->my_tree.max_node_size){
			...
			RemoveDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* remove_node = new RemoveDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, neighbour_node_id);
			...
			if(!ret_val)
				return false;
			Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *node_ = this->my_tree.table.Get(this->id);
			MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* merge_node = new MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id);
			...
			if(!ret_val)
				return false;
			uint64_t parent_id = path[index-1];
			Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* parent_node_pointer = this->my_tree.table.Get(parent_id);
			Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *cur_pointer = parent_node_pointer;
			while(cur_pointer->next)
				cur_pointer = cur_pointer->next;
			InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* parent_pointer = dynamic_cast<InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(cur_pointer);
			uint64_t parent_size = this->my_tree.Get_size(parent_id);
		...
		if(total_count > this->my_tree.max_node_size){
			...
			Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *node_ = this->my_tree.table.Get(this->id);
			RemoveDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* remove_node = new RemoveDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id);
			...
			InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_pointer = dynamic_cast<InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_);
			MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* merge_node = new MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, neighbour_node_id);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Leaf_merge(uint64_t *path, uint64_t index, KeyType key, __attribute__((__unused__) )ValueType value){
  bool ret_val = this->my_tree.Consolidate(this->id, true);
  if (!ret_val)
  {
    return ret_val;
  ...
  if(this->sibling_id != 0){
	...
	Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* n_node_ = this->my_tree.table.Get(neighbour_node_id);
	LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* n_node_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(n_node_);
    ...
    remove_node->chain_len = chain_len+1;
		...
		LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_);
		MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* merge_node = new MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, neighbour_node_id);
		merge_node->node_to_be_merged = node_pointer;
		merge_node->next = n_node_pointer;
...
/*
  ...
  if(index > 0){
	  uint64_t parent_id = path[index-1];
	  pair<Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*, uint32_t> parent_node_ = this->my_tree.table.Get(parent_id);
	  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_pointer = parent_node_.first;
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Consolidate(){
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_ = this->my_tree.table.Get(this->id);

  uint64_t new_id = this->my_tree.table.Get_next_id();
  LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *new_leaf_node = new LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, new_id);
  multimap<KeyType, ValueType, KeyComparator> insert_set;
  multimap<KeyType, ValueType, KeyComparator> delete_set;
  DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *temp = dynamic_cast<DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *>(node_);
  LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *leaf_node = this;
  bool stop = false;
  while (!stop) {
    if (temp -> type == DELETE)
    {
    ...
    if (temp -> next -> type == LEAF_BW_NODE) {
      ...
      temp = dynamic_cast<DeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *>(temp -> next);
    }
  }
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
uint64_t BWTree<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Get_size(uint64_t node_id) {
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* node_pointer = table.Get(node_id);
  uint64_t count = 0;
  bool end = false;
  ...
  {
    // Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* simple_pointer = nullptr;
    switch(node_pointer->type){
      case(INSERT):
        count++;
        break;
...
{        LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* leaf_pointer = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
      ...
      case(SPLIT):
        break;
      case(MERGE):
{        MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* mdn = dynamic_cast<MergeDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(node_pointer);
        LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>* to_be_merged = dynamic_cast<LeafBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>*>(mdn->node_to_be_merged);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Internal_insert(KeyType split_key, KeyType boundary_key, uint64_t new_node_id){
  Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *node_pointer = this->my_tree.table.Get(this->id);
  SplitIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *split_index = new SplitIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Internal_split(uint64_t *path, uint64_t index, 
  ...
  InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *new_internal_node = new InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, new_internal_node_id);
  ...
  ret_val = this->my_tree.table.Install(new_internal_node_id, new_internal_node);
  if(!ret_val)
    return false;
  split_node->chain_len = chain_len + 1;
  ret_val = this->my_tree.table.Install(this->id, split_node);
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
uint64_t InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Get_child_id(KeyType key) {
...
template <typename KeyType, typename ValueType, typename KeyComparator, typename KeyEqualityChecker, typename ValueEqualityChecker>
bool InternalBWNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>::Internal_delete(KeyType merged_key){

	Node<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *node_pointer = this->my_tree.table.Get(this->id);
	RemoveIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker> *remove_index = new RemoveIndexDeltaNode<KeyType, ValueType, KeyComparator, KeyEqualityChecker, ValueEqualityChecker>(this->my_tree, this->id);
